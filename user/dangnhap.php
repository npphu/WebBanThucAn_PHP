...
<body>
						...
						<div class="input-group mb-2">
							...
							<input type="password" name="txtMatKhau" class="form-control input_pass" value="" placeholder="Nhập mật khẩu"/>
                                                ...
                                                <div class="input-group mb-2 actions">						
                                                    <input type="submit" tabindex="1"  class="btn login_btn" name="btnDangNhap" class="form-control input_pass" value="Đăng nhập"/>
						</div>                                      
					</form>
				</div>				
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
                                            <a href="dangky.php" class="ml-2">Tạo tài khoản mới</a>
					</div>
					<div class="d-flex justify-content-center links">
    ...
    if (isset($_POST['btnDangNhap'])) {
        ...
        $ds = $conn->query("Select iduser, tenuser, passuser,dienthoai, hoten, diachi from NguoiDung WHERE tenuser='$user'");
        ...
        if ($password == $row['passuser']) {
            $_SESSION['NguoiDung'] = $row['hoten'];
            $_SESSION['IDNguoiDung'] = $row['iduser']; 
            $_SESSION['DCNguoiDung'] = $row['diachi'];
             $_SESSION['DTNguoiDung'] = $row['dienthoai'];
