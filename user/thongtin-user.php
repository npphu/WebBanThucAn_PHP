                ...
                <div class="navbar-inner main-menu">
                    ...
                    <nav id="menu" class="pull-right">
                        <ul>
                            <?php
                            if (isset($_SESSION['NguoiDung'])) {
                                echo '<li><a href="../index.php">Trang chủ</a></li> <li><a>Chào ' . $_SESSION['NguoiDung'] . '</a></li>';
                            }
                            ?>                           
                        </ul>
            ...
            <section class="main-content">
                <div class="row">
                    <div class="span12">
                        <div class="row">
                            <div class="span12">                                
                                <h4 class="center">THÔNG TIN USER</h4>
                                <p class="container right">
                                    <a href="sua-thongtinuser.php?IdUser=<?php echo $iduser; ?>">  <img src="../images/icon/icon-update.png" style="width: 50px; height: 50px" title="Sửa" alt=""/> </a>                             
                                </p>
                                <table class="table table-bordered table-hover table-striped" style="font-size:14px">
                                    <thead style="background-color:orange">                                       
                                                ...
                                                <?php
                                                    ...
                                                    $ctv = $conn->query("Select * from NguoiDung WHERE NguoiDung.IdUser = '$iduser'");                                            
