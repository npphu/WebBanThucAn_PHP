        ...
        <div id="wrapper" class="container">
            <section class="navbar main-menu">
                <div class="navbar-inner main-menu">
                    <a href="loai.php"><img src="../images/LogoBanner/logo-sfood.png" style="height:55px; width:193px" alt=""></a>
                    ...
                    <div class="span12">
                        <div class="row">
                            <div class="span12">
                                ...
                                <h4 class="center">DANH SÁCH LOẠI</h4>
                                <p class="container left">
                                    <a href="them-loai.php">  <img src="../images/icon/icon-add_1.png" style="width: 60px; height: 60px" title="Thêm mới" alt=""/> </a>                             
                                </p>
                                        ...
                                        <tr>
                                            ...
                                            <th class="center">Tùy chọn</th>
                                                ...
                                                <?php
                                                    ...
                                                    $ctv = $conn->query("SELECT * from LoaiMonAn order by LoaiMonAn.TenLoai asc");                                            
                                                    while($row= mysqli_fetch_array($ctv))
                                                    {
                                                        echo '<tr>
                                                                <td class="center" style="vertical-align: middle">
                                                                    ...
                                                                    <td class="center" style="vertical-align: middle">
                                                                        <a href="sua-loai.php?IdLoai='.$row['IdLoai'].'">  <img src="../images/icon/icon-update.png" style="width: 40px; height: 40px" title="Sửa món ăn" alt=""/> </a>                          
                                                                        <a href="xoa-loai.php?IdLoai='.$row['IdLoai'].'" title="BCDONLINE CONFIRM YES/ NO" onclick="return confirmAction()">  <img src="../images/icon/icon-delete.png" style="width: 40px; height: 40px" title="Xóa món ăn" alt=""/> </a>                                           
                                                                    </td>
                                                                </tr>';
                                                    }                                                  
                                                ?>                                                  
