...
<body>
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
                                    <form method="post" action="dangnhap-admin.php">
   ...
   if (isset($_POST['btnDangNhap'])) {
        ...
        $ds = $conn->query("Select idadmin, tenadmin, pasadmin from Admin WHERE tenadmin='$user'");
        
        $pass = md5($_POST['txtMatKhau']);
        $password = 'admin';
        $row = mysqli_fetch_array($ds);

        if ($password == $row['pasadmin']) {
            $_SESSION['Admin'] = $row['tenadmin'];          
